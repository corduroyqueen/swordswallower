...
dialogue_array[0] = "You got a santa hat? Press 1 and 2 to cycle through hats. "
...
if player_present {
	...
	if player_obj.k_speak_p {
		if ds_list_find_index(level1_master.hats_list,"2")<0 {
			ds_list_add(level1_master.hats_list,2)
		}
