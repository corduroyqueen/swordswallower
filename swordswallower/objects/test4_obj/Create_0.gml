...
normalDepthTexture = sprite_get_texture(wallflat_n, 0);
specGlossMap = sprite_get_texture(wallflat, 0);
aoMap = sprite_get_texture(wallflat, 0);
emissiveMap = sprite_get_texture(wallflat, 0);
