...
if state==state_attacking && attack==attack_wall_hands {
	if ht>119 {
		h1_lerp = 0
		h2_lerp = 0
	} else if ht>80 {
		h1_lerp = lerp(h1_lerp,70,0.2)
		h2_lerp = lerp(h2_lerp,-40,0.2)
	} else {
	...
	draw_sprite_ext(sprite1066,0,h2_x+540,h2_y+f+30+h2_lerp+40,0.5,0.5,0,c_white,1)
