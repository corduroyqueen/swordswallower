...
draw_sprite_ext(finaltitle,0,camx+960,camy+450,1,1,0,c_white,alpha*15)
draw_sprite_ext(comingsoon,0,camx+960,camy+750,1,1,0,c_white,alpha*10)
draw_sprite_ext(twitterlink,0,camx+960,camy+840,1,1,0,c_white,alpha*8)
