...
normalDepthTexture = sprite_get_texture(floor2normal, 0);
specGlossMap = sprite_get_texture(wall_spr2, 0);
aoMap = sprite_get_texture(wall_spr2, 0);
emissiveMap = sprite_get_texture(wall_spr2, 0);
...
upperAmbient_Red = 0.03;
upperAmbient_Green = 0.03;
upperAmbient_Blue = 0.03;
