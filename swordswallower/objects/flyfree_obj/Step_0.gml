...
if death {
	if death_timer< 1 {
		if player_obj.zoom_timer_bool {
			just_blood(player_obj.hspeed,player_obj.vspeed*2,0.3,30,false,sprite_width/4,sprite_height)
		} else {
...
if state==state_idle {
	...
	if distance_to_object(player_obj)<750 && bound_conditional(within_bound) && in_camera_range(x,y) {
