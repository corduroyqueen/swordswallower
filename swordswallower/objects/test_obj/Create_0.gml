...
normalDepthTexture = sprite_get_texture(floor2normal_bad, 0);
specGlossMap = sprite_get_texture(wall_specgloss, 0);
aoMap = sprite_get_texture(wall_ao, 0);
emissiveMap = sprite_get_texture(wall_normal, 0);
...
upperAmbient_Red = 0.6;
upperAmbient_Green = 0.6;
upperAmbient_Blue = 0.6;

lowerAmbient_Red = 0.6;
lowerAmbient_Green = 0.6;
lowerAmbient_Blue = 0.6;
