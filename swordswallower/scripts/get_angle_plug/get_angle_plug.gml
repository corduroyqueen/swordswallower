...
if dy>=(local_obj.image_yscale * 16) { anga = local_obj.image_angle+90 }
if dy<=(-local_obj.image_yscale * 16) { anga = local_obj.image_angle+270 }


dx = dot_product(tarx,tary,direcxh,direcyh)
if dx>=(local_obj.image_xscale * 16) { anga = local_obj.image_angle }
if dx<=(-local_obj.image_xscale * 16) { anga = local_obj.image_angle+180 }
