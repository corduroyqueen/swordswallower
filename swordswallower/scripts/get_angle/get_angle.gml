...
if dy>=(local_obj.sprite_height/2) { ang = local_obj.image_angle+90 }
if dy<=-(local_obj.sprite_height/2) { ang = local_obj.image_angle+270 }


dx = dot_product(tarx,tary,direcxh,direcyh)
if dx>=(local_obj.sprite_width/2) { ang = local_obj.image_angle }
if dx<=-(local_obj.sprite_width/2) { ang = local_obj.image_angle+180 }
