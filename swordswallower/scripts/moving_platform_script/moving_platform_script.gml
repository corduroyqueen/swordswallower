...
if place_meeting(x,y+2,obj) {
	if instance_place(x,y+2,obj).vertical {
		if !instance_place(x,y+2,obj).onedirec {
			...
			var xt = x + instance_place(x,y+2,obj).hsp
			//var yt = y + instance_place(x,y+2,obj).vsp	
			x = xt
			//y = yt
			
			if instance_place(x,y+2,obj).vsp<0 {
			...
			if place_meeting(x,y,wall_obj) {
				var h = hsp
				var v = vsp
				hsp = instance_place(x,y+2,obj).hsp
				vsp = instance_place(x,y+2,obj).vsp
				default_collision(wall_obj)
			}
		} else {
			var xlast = x
			
			//x = x + instance_place(x,y+2,obj).hsp/10
			if !place_meeting(x,y,tar_obj)
			&& instance_place(x,y+2,obj).vsp < 
			((instance_place(x,y+2,obj).starty+instance_place(x,y+2,obj).dist2)-instance_place(x,y+2,obj).y) {
				
				y+=instance_place(x,y+2,obj).vsp
			}
