...
&& collision_line(x,y,obj.x,obj.y,illusion_wall_obj,false,true)==noone
&& collision_line(x,y,obj.x,obj.y,burn_wall_obj,false,true)==noone
...
&& collision_line(x,y,obj.x,obj.y,key_door_obj,false,true)==noone
